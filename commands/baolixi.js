...
var b = Math.floor(Math.random() * 900) + 600; 
var c = Math.floor(Math.random() * 800) + 700; 
var x = Math.floor(Math.random() * 700) + 800; 
var y = Math.floor(Math.random() * 600) + 900; 
var f = Math.floor(Math.random() * 500) + 1000; 
