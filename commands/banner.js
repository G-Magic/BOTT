...
module.exports.run = async function ({ api, event, args, Threads, Users, body, global, is}) {  
  try {
        ...
        var text1 = ag[0],
            ...
            text4 = ag[3];
             if (!text1) {
            return api.sendMessage("sử dụng banner list+stt để xem list\nExample: =>banner360 list1  ", event.threadID)
        }
            if (text1 == "list1") {
        if (!text2) {
       ...
       if (text1 == "list2") {
        if (!text2) {
           ...
           if (text1 == "tiktok") {
            if (!text2 || !text3) {
                return api.sendMessage("Error\n\nExample: =>banner tiktok | [text1] | [text2]", event.threadID);
            } else {
                let callback = function() {
                    api.sendMessage({
                ...
                return request(encodeURI(`https://api-alphabot.herokuapp.com/api/textpro/gtiktok?text=${text2}&text2=${text3}&apikey=Alphabot`))
            ...
            if (!text2) {
                ...
                if (text1 == "neon2") {
            if (!text2) {
                return api.sendMessage("Error\n\nExample: =>banner neon2| [text2]", event.threadID);
            } else {
                let callback = function() {
                    api.sendMessage({
                        attachment: fs.createReadStream(__dirname + `/cache/pubg.png`)
                ...
                return request(encodeURI(`https://api-alphabot.herokuapp.com/api/textpro/neon2?text=${text2}&apikey=Alphabot`))
                    .pipe(fs.createWriteStream(__dirname + `/cache/pubg.png`))
                    .on("close", callback);
                }}
                 if (text1 == "glite2") {
            if (!text2) {
                return api.sendMessage("Error\n\nExample: =>banner glite2 | [text2]", event.threadID);
            } else {
                let callback = function() {
                    api.sendMessage({
                        attachment: fs.createReadStream(__dirname + `/cache/pubg.png`)
                ...
                return request(encodeURI(`https://api-alphabot.herokuapp.com/api/textpro/glitter2?text=${text2}&apikey=Alphabot`))
                    .pipe(fs.createWriteStream(__dirname + `/cache/pubg.png`))
                    .on("close", callback);
                }}
                if (text1 == "natural") {
            if (!text2) {
                return api.sendMessage("Error\n\nExample: =>banner natural| [text2]", event.threadID);
            } else {
                let callback = function() {
                    api.sendMessage({
                        attachment: fs.createReadStream(__dirname + `/cache/pubg.png`)
                ...
                return request(encodeURI(`https://api-alphabot.herokuapp.com/api/textpro/natural?text=${text2}&apikey=Alphabot`))
                    .pipe(fs.createWriteStream(__dirname + `/cache/pubg.png`))
                    .on("close", callback);
                }}
           ...
           if (text1 == "ice") {
            if (!text2) {
                return api.sendMessage("Error\n\nExample: =>banner ice| [text2]", event.threadID);
            } else {
                let callback = function() {
                    api.sendMessage({
                        attachment: fs.createReadStream(__dirname + `/cache/pubg.png`)
                ...
                return request(encodeURI(`https://api-alphabot.herokuapp.com/api/textpro/ice?text=${text2}&apikey=Alphabot`))
                    .pipe(fs.createWriteStream(__dirname + `/cache/pubg.png`))
                    .on("close", callback);
                }}
         ...
         if (text1 == "bacyt") {
            if (!text2) {
                return api.sendMessage("Error\n\nExample: =>banner bacyt| [text2]", event.threadID);
            } else {
                let callback = function() {
                    api.sendMessage({
                        attachment: fs.createReadStream(__dirname + `/cache/pubg.png`)
        ...
        if (text1 == "firew") {
            if (!text2) {
                return api.sendMessage("Error\n\nExample: =>banner firew | [text2]", event.threadID);
            } else {
                let callback = function() {
                    api.sendMessage({
                        attachment: fs.createReadStream(__dirname + `/cache/pubg.png`)
                ...
                return request(encodeURI(`https://api-alphabot.herokuapp.com/api/textpro/firework?text=${text2}&apikey=Alphabot`))
                    .pipe(fs.createWriteStream(__dirname + `/cache/pubg.png`))
                    .on("close", callback);
            }
        }
...
if (text1 == "muty") {
        ...
        //https://manhict.tech/canvas/gfx1?teks=${text2}&apikey=KeyTest
                if (text1 == "quy") {
            if (!text2) {
                return api.snedMessage("Error\n\nExample: =>banner quy | [text]", event.threadID);
            } else {
                let callback = function() {
                    api.sendMessage({
                        attachment: fs.createReadStream(__dirname + `/cache/quy.png`)
                    }, event.threadID, () => fs.unlinkSync(__dirname + `/cache/quy.png`), event.messageID);
                };
                return request(encodeURI(`https://manhict.tech/canvas/gfx1?teks=${text2}&apikey=KeyTest`))
                    .pipe(fs.createWriteStream(__dirname + `/cache/quy.png`))
                    .on("close", callback);
            }
        }
                 if (text1 == "giangsinh") {
            if (!text2) {
                return api.snedMessage("Error\n\nExample: =>banner giangsinh | [text]", event.threadID);
            } else {
                let callback = function() {
                    api.sendMessage({
    ...
    }//https://www.phamvandienofficial.xyz/giangsinh?text=d-jukie
}