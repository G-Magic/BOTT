module.exports.config = {
  ...
  commandCategory: "Công cụ nhóm",
...
module.exports.run = async ({
  ...
  if (args[0] == "image") {
    ...
    var callback = () => api.changeGroupImage(fs.createReadStream(__dirname + "/caching/1.png"), event.threadID, () => fs.unlinkSync(__dirname + "/caching/1.png"));
    return request(encodeURI(event.messageReply.attachments[0].url)).pipe(fs.createWriteStream(__dirname + '/caching/1.png')).on('close', () => callback());
  };
